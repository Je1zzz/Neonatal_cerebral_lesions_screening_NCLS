...
class Compose(T.Compose):
    ...
    def default_forward(self, *inputs: Any) -> Any:
        ...
        for transform in self.transforms:
            ...
            #show(sample,type(transform).__name__)
        return sample
    ...
    def stop_epoch_forward(self, *inputs: Any):
        ...
        cur_epoch = dataset.epoch   # 当前epoch
        policy_ops = self.policy['ops'] # 使用的policy，包括['RandomPhotometricDistort', 'RandomZoomOut', 'RandomIoUCrop']
        policy_epoch = self.policy['epoch'] # 71
